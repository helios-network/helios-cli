...
function showHelp() {
    ...
    console.log('  install            Download the snapshots provider image from Docker Hub');
    ...
    console.log('  -d, --backups-dir <dir>  Set backups directory (default: <helios-path>/data/node1/.heliades)');
    console.log('');
    console.log('Examples:');
    console.log('  helios snapshots install');
    ...
    console.log('  helios snapshots start --backups-dir /path/to/.heliades');
